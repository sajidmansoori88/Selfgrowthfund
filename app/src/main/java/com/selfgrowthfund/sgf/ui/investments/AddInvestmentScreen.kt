...
fun AddInvestmentScreen(
    ...
    Column(modifier = Modifier.padding(16.dp)) {
        Text("Next Investment ID: ${nextId ?: "Loading..."}", style = MaterialTheme.typography.labelMedium)
        ...
        Button(
            onClick = {
                ...
                val investeeTypeEnum = safeValueOf<InvesteeType>(investeeType) ?: InvesteeType.External
                val paymentModeEnum = safeValueOf<PaymentMode>(modeOfPayment) ?: PaymentMode.OTHER
                val statusEnum = safeValueOf<InvestmentStatus>(status) ?: InvestmentStatus.Active
                ...
                viewModel.submitInvestment(investment, onSuccess) { validationError.value = it }
            },
